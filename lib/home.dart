...
class _homeState extends State<home> {
  ...
  Widget build(BuildContext context) {
    return Consumer<MainScreenNotifier>( // setting up the provider for the state mangement process 
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                BottomNavWidget(
                  onTap: () {
                    mainScreenNotifier.pageset = 0; // setting the variable of the notifier hence automatically the notify listeners will get called
                  },
                ...
                BottomNavWidget(
                  ...
                  icon: mainScreenNotifier.pageIndex !=1 ? Icons.manage_search_outlined : Icons.search,
                ...
                BottomNavWidget(
                  ...
                  icon: mainScreenNotifier.pageIndex ==2 ? Icons.add_circle : Icons.add_circle_outline,
                ),
                BottomNavWidget(
                  onTap: () {
                ...
                BottomNavWidget(
                  ...
                  icon:mainScreenNotifier.pageIndex == 4 ?  Icons.person_2:Icons.person_2_outlined,
                ),
              ],
            ),
          ),
